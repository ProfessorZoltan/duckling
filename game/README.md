...
| `world/pond_greybox.gd` | The act director: Prologue → Keep Up → First Supper → The Shadow → Growth Spurt 1 → The Far Shore and the Culvert (siblings through, Marra flies, Heart 10) → Nib and her pantry. Sets the objective line and Marra's and Pip's lines at each beat. |
